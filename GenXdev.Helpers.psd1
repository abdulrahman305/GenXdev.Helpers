...
CmdletsToExport = 'Add-Content', 'Add-Member', 'Add-Type', 'Clear-Content', 'Clear-Item', 
               ...
               'ConvertTo-Xml', 'Copy-IdenticalParamValues', 'Copy-Item', 
               'Copy-ItemProperty', 'Debug-Process', 'Debug-Runspace', 
               ...
               'Format-Wide', 'Get-Alias', 'Get-AudioDeviceNames', 'Get-ChildItem', 
               'Get-Clipboard', 'Get-ComputerInfo', 'Get-Content', 'Get-Counter', 
               'Get-Culture', 'Get-Date', 'Get-Error', 'Get-Event', 
