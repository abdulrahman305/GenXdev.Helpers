...
FunctionsToExport = 'alignScript', 'ConvertTo-HashTable', 'ConvertTo-JsonEx', 
               'Copy-IdenticalParamValues', 'Get-ImageGeolocation', 'Out-Serial', 
               'Remove-JSONComments'
...
FileList = 'auth_assets\logo.svg', 'auth_assets\main.js', 
               ...
               'lib\runtimes\win-x86\whisper.dll', 'lib\Azure.Core.dll', 
               'lib\Azure.Identity.dll', 'lib\BouncyCastle.Cryptography.dll', 
               'lib\EmbedIO.dll', 'lib\GenXdev.CoreHelpers.dll', 
               ...
               'Tests\TestResults.xml', 'GenXdev.Helpers.psd1', 
